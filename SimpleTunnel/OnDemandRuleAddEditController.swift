	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		...
		switch identifier {
			...
			case "edit-interface-type-match":
				...
				enumController.setValues([String(stringValues)], title: "Interface Type", currentSelection: currentSelection) { newRow in
			...
			case "edit-on-demand-action":
				...
				enumController.setValues([String(stringValues)], title: "Action", currentSelection: currentSelection) { newRow in
