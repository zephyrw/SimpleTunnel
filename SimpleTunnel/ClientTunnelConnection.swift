...
class ClientTunnelConnection: Connection {
	...
	func open() {
		...
		let properties = createMessagePropertiesForConnection(identifier, commandType: TunnelCommand.open, extraProperties:[
	...
	func handlePackets(_ packets: [Data], protocols: [NSNumber]) {
		...
		let properties = createMessagePropertiesForConnection(identifier, commandType: TunnelCommand.packets, extraProperties:[
